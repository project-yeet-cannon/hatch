...
/// provider owns what a calendar is, the admin owns what Aerie does with it -
...
public class CalendarDiscoveryServiceTests
{
    ...
    private static (CalendarDiscoveryService Service, AerieContext Db, Guid AccountId) NewService(
    ...
    private static async Task<List<EfCalendar>> Calendars(AerieContext db, Guid accountId) =>
