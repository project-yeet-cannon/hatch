...
public sealed class RunnerControllerTests : IDisposable
{
    ...
    [InlineData("..")]
    [InlineData("win-x64/../../out/Aerie.Api.dll")]
    [InlineData("")]
    ...
    private sealed class StubRevision(string revision) : IAerieRevision
    {
        public string Revision { get; } = revision;
        public int Sequence => 1;
        public DateTimeOffset? BuiltAt => null;
        public bool IsDevelopment => Revision == Aerie.Api.Services.AerieRevision.Development;
    }
    ...
    private sealed class StubEnvironment(string webRoot) : IWebHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = "Aerie.Api.Tests";
