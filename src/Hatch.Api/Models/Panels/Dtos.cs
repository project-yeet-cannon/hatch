...
namespace Hatch.Api.Models.Panels;
...
/// <summary>The kiosk's setpoint write, in F. One request per settled interaction - holding "+" from 68 to 78 sends this once, not ten times (docs/kiosk-architecture.md).</summary>
