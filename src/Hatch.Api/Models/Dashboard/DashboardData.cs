...
namespace Hatch.Api.Models.Dashboard;

// These records are the server side of the dashboard's data contract. They must
// serialize to exactly the shape in Hatch.Web/apps/dashboard/src/types.ts (camelCase
...
/// <summary>
/// The four sun events (see <see cref="Hatch.Api.Services.Dashboard.SolarCalculator.EventsForDay"/>)
...
/// <summary>
/// One thing outside worth saying out loud, in Hatch's vocabulary rather than
