...
namespace Hatch.Api.Models.DeviceMapping;
...
/// <summary>An HA device with no matching Hatch Device.HaDeviceId yet, with suggested name/kind/channels pre-populated for one-click import - see IDiscoveryService.</summary>
