...
/// <c>Hatch-Client-Revision</c> - which is every caller that isn't one of
/// Hatch's own web apps, and every app build from before this shipped.
/// </param>
/// <param name="Cluster">
...
/// </param>
public record HatchRevisionInfo(
    string Revision,
    int Sequence,
