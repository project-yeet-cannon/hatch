...
/// holds a key to it (docs/plans/immich.md v+2) - it asks Hatch for a manifest
    ...
    TimeProvider time) : ControllerBase
{
    ...
    /// <summary>Every album Hatch knows about, whether or not it is on the wall. Ordered the way the admin arranged them.</summary>
    [HttpGet("albums")]
    ...
    /// is reachable because the album is one Hatch knows about, whereas an
