...
using Hatch.Api.Models.VmConsoleLogs;
...
/// the Hyper-V host - see New-HatchVM.ps1) and writes them through the normal
/// ILogger pipeline, so they flow into the existing docker.* -> fluent-bit ->
/// OpenSearch hatch-logs index alongside every other Hatch.Api log line,
