...
/// topology fact, fixed by how Hatch is installed, and it should not be
...
/// out of both Hatch's database and its git history.
/// </summary>
public class CameraStreamOptions
{
    ...
    /// resolves in the cluster because charts/hatch names that Service "go2rtc"
