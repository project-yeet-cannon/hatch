...
/// a complete account of what Hatch has done to the house rather than a partial
    ...
    ILogger<ClimateCommandService> logger) : IClimateCommandService
{
    ...
    public async Task<CommandResult> DispatchAsync(CommandRequest request, CancellationToken ct)
    {
        ...
        // still leaves evidence that Hatch tried - an actuation that vanished from
    ...
    /// button in the admin UI, or triggering a routine, is telling Hatch what
