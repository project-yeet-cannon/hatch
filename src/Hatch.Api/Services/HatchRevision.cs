...
/// </summary>
public interface IHatchRevision
{
    /// <summary>Full 40-character git sha, or <see cref="HatchRevision.Development"/>.</summary>
    string Revision { get; }
...
/// answer.
/// </summary>
public class HatchRevision : IHatchRevision
{
    /// <summary>
    /// What an unstamped build reports. Kept identical to the same constant in
    /// Hatch.Web/vite-plugin-hatch-revision.ts so a dev build reads the same on
    /// both sides of the wire.
    /// </summary>
    public const string Development = "dev";

    private const string SequenceKey = "HatchSequence";
    ...
    public HatchRevision() : this(typeof(HatchRevision).Assembly) { }

    public HatchRevision(Assembly assembly)
    {
