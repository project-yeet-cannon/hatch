...
public sealed class IssueCommandsTests
{
    ...
    public async Task Show_prints_the_comments_under_a_count_of_them()
    {
        ...
        {
            new CommentDto(1, "aerie-hatch", "First.", "", null, null, DateTimeOffset.UnixEpoch),
        ...
        Assert.Contains("[1970-01-01T00:00:00+00:00] aerie-hatch:", h.Said);
    ...
    public async Task A_comment_is_posted_whole_and_the_author_is_read_back()
    {
        ...
        h.Wire.Json("POST", "/api/hatch/issues/AER-12/comments",
            new CommentDto(7, "aerie-hatch", "sha abc123", "", null, null, DateTimeOffset.UnixEpoch));
        ...
        Assert.Equal("commented on AER-12 as aerie-hatch", h.Said);
    }
    ...
    public async Task A_comment_body_that_looks_like_a_flag_is_still_a_comment()
    {
        using var h = new CliHarness();
        h.Wire.Json("POST", "/api/hatch/issues/AER-12/comments",
            new CommentDto(1, "aerie-hatch", "--help", "", null, null, DateTimeOffset.UnixEpoch));
