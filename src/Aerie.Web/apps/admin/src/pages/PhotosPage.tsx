    ...
    <div className="card mb-2">
      ...
      <div className="grid cols-2">
        ...
        <div className="field">
          ...
          <p className="text-muted mt-1">
            From Immich: <strong>Account settings → API Keys → New API Key</strong>. Stored obfuscated and never sent
            back to a browser; leave blank to keep the current one.
          </p>
        </div>
      </div>
...
function explain(error: string | null): string {
  switch (error) {
    case 'unauthorized':
      return 'Immich refused that API key. Check it was copied whole, and that it has not been revoked over there.';
    case 'unreachable':
  ...
  return (
    <div className="card">
      ...
      <ol className="text-muted">
        <li>In Immich, open Account settings → API Keys and make one. Copy it once; Immich will not show it again.</li>
