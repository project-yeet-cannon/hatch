...
// The family shell runs installed to a phone home screen, where there is no
// devtools window at all - console.warn/console.error would otherwise vanish
// entirely. Mirror them into the shipped log stream, while still calling
// through so devtools behave normally when it is opened on a desktop.
