...
/** Collected once per page load: things that won't change while the kiosk sits open. */
...
/** Recomputed on every log call: things that can change over the kiosk's lifetime. */
