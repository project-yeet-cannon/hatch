...
public class AuthCookieTests
{
    private static AuthOptions Options(string cookieDomain = ".example.com") =>
        new() { CookieName = "__Secure-hatch_grant", CookieDomain = cookieDomain };
    ...
    public void ReadAllKeepsEveryCookieOfTheName()
    {
        ...
        var request = RequestWith("__Secure-hatch_grant=stale; other=x; __Secure-hatch_grant=good");
    ...
    public void ReadAllIgnoresBlanksAndOtherNames()
    {
        ...
        var request = RequestWith("__Secure-hatch_grant=; session=abc; __Secure-hatch_grant=good");
    ...
    public async Task AStaleCookieInFrontOfAGoodOneDoesNotLockTheDeviceOut()
    {
        ...
        var gate = new AuthGate(
            ...
            Microsoft.Extensions.Options.Options.Create(new global::Hatch.Api.Services.Media.MediaLibraryOptions { RequestPath = "/media" }),
    ...
    public void IssueSendsTheGrantCookieAndATombstoneForTheHostOnlyOne()
    {
        ...
        Assert.StartsWith("__Secure-hatch_grant=a-token;", headers[0]!);
        Assert.Contains("domain=.example.com", headers[0]!, StringComparison.OrdinalIgnoreCase);

        Assert.StartsWith("__Secure-hatch_grant=;", headers[1]!);
    ...
    public void IssueSendsNoTombstoneWhenTheCookieIsHostOnlyByDesign()
    {
        ...
        Assert.StartsWith("__Secure-hatch_grant=a-token;", only!);
    }
}
