...
/// and noticing when something outside Hatch later undid it. The conservative
/// rule under test throughout: nothing counts as an override unless Hatch first
...
public class ReconcileCommandsTests
{
    ...
    private static ReconcileCommands NewJob(AppDbContext db, DateTimeOffset now, int backoffMinutes = 120) =>
