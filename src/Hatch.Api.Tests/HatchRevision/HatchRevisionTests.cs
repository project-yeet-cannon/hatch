...
namespace Hatch.Api.Tests.HatchRevision;
...
/// </summary>
public class HatchRevisionTests
{
    ...
    {
        Assert.Equal(Sha, Api.Services.HatchRevision.ParseRevision($"1.0.0+{Sha}"));
    }
    ...
    {
        Assert.Equal("dev", Api.Services.HatchRevision.ParseRevision(informationalVersion));
    }

    [Fact]
    public void ParseSequence_ReadsAPositiveCount()
    {
        Assert.Equal(4127, Api.Services.HatchRevision.ParseSequence("4127"));
    }
    ...
    {
        Assert.Equal(0, Api.Services.HatchRevision.ParseSequence(value));
    }
    ...
    public void ARealAssemblyAlwaysReadsAsEitherAShaOrDev()
    {
        ...
        var revision = new Api.Services.HatchRevision(typeof(HatchRevisionTests).Assembly);
