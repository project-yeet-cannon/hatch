...
public class PlanImportParserTests
{
    ...
    public void ThisPlansOwnShape_ParsesToItsPhases()
    {
        var epic = Parser.Parse("pjm.md", """
            ...
            Hatch's projects are currently managed by juggling markdown files.
            ...
            - [x] Create `src/Hatch.Api/Modules/Hatch/Entities.cs` with the five entities
                  exactly as the Domain model section above specifies, and
                  `src/Hatch.Api/Modules/Hatch/HatchContext.cs`.
            - [x] Create `src/Hatch.Api/Modules/Hatch/HatchDesignTimeFactory.cs`
            ...
            - [ ] Create `src/Hatch.Api/Modules/Hatch/PlanImportParser.cs`: pure function
