...
public class HazardSyncServiceTests
{
    ...
    private static async Task<List<EfWeatherAlert>> Rows(IDbContextFactory<AppDbContext> db) =>
    ...
    private static async Task<IDbContextFactory<AppDbContext>> NewDb(params EfWeatherAlert[] alerts)
    {
