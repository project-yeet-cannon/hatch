...
/// write Aerie makes (docs/climate-brain-architecture.md).
/// </summary>
[ApiController]
[Route("api/[controller]")]
public class PanelsController(AerieContext db, IPanelService panels, IClimateCommandService commands) : ControllerBase
{
    [HttpGet]
