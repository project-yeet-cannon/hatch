...
/// Phase 1) by comparing what Aerie asked for against what SampleChannels
...
///    observation that no longer matches it, with no Aerie command behind the
...
public class ReconcileCommands(
    TimeProvider time, AerieContext db, ISiteSettingsService siteSettings, ILogger<ReconcileCommands> logger) : IAerieJob
{
