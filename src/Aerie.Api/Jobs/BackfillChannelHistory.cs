...
/// range for one Device's channels, for backfilling a fresh Aerie install
...
/// </summary>
public class BackfillChannelHistory(HistoryClient haHistory, AerieContext db, IChannelHistoryWriter writer, ILogger<BackfillChannelHistory> logger) : IJob
{
    public const string Name = "BackfillChannelHistory";
    public const string Group = "Aerie.Api";
