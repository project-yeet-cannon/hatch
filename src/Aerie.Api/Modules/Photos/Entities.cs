...
/// <summary>
/// One album as Immich reports it, plus the one fact Aerie owns about it:
...
/// Aerie owns <see cref="Included"/> and <see cref="SortOrder"/>, which a
...
public class PhotoAlbum
{
    ...
    /// <summary>When Aerie last wrote this row, from either half - a refresh or an operator's toggle.</summary>
