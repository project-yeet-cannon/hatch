...
[RequireAdmin]
public class RunnerController(IAerieRevision revision, IWebHostEnvironment env) : ControllerBase
{
    /// <summary>
    ...
    /// <c>/api/aerie-revision</c>: it is a fact about the binaries listed
