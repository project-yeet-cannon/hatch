...
public class EfCommand
{
    ...
    /// undone by something outside Aerie (see EfControlOverride). Doubles as the
...
/// <summary>
/// A detected human override: a channel Aerie had successfully set was later
/// observed carrying something else, with no Aerie command behind the change.
///
/// This is what "single writer" means in practice - not that nothing else can
/// write to the entity, but that Aerie notices when something did and yields
...
public class EfControlOverride
{
    ...
    /// <summary>What Aerie had set the channel to, and what it was found carrying instead.</summary>
    public string? ExpectedState { get; set; }
    public string? ObservedState { get; set; }

    /// <summary>Until when the controller leaves this device alone. Human- and Routine-sourced commands are unaffected - a person telling Aerie to do something is not the same as a person overriding it.</summary>
