    ...
    ILogger<NwsAlertProvider> logger) : IWeatherAlertProvider
{
    ...
    /// alert whose severity Aerie cannot read is still an alert worth showing.
    /// </summary>
    ...
    {
        if (NullIfEmpty(contact) is { } identified) return $"Aerie/1.0 ({identified})";
    ...
    /// <summary>
    /// The properties Aerie reads off a feature. Timestamps stay strings until
