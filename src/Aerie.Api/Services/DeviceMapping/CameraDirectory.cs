...
/// verbatim what <see cref="Aerie.Api.Controllers.CameraController"/> asks
...
/// </summary>
public class CameraDirectory(IDbContextFactory<AerieContext> dbFactory) : ICameraDirectory
{
