...
| [`pjm.md`](pjm.md) | **Hatch** — the house project tracker at `hatch.${DOMAIN}`: a kanban board, issues with Jira-style keys, and an API for Claude. Phases 0-6 complete; phase 7 is the operator-paced migration |
